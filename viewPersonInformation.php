...
<html lang="en">
  ...
  <body>
	...
	<h2>Student/Tutor Information</h2>
	...
	<?php
			...
			//bind entered parameters to mysqli statement
				...
				while(mysqli_stmt_fetch($stmt))
				{
					...
					<tr>
						...
						<td>".$email."</td>
						<td>".$pos."</td>
						";if(isset($_SESSION)){$_SESSION['viewID']=$uID; $_SESSION['uFirstName']=$fn; $_SESSION['uLastName']=$ln; $_SESSION['uPosition']=$pos;}echo"
					</tr>
					</table>";
				}//end of while
		...
		<form class="form-horizontal" method="post" action="viewPersonDashboard.php">

		<input type="submit" class="btn btn-primary form-control" name="submit" value="View User Dashboard"/>
