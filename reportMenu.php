	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="reportMenu.php"> Report Menu</a>
	    </div>
		<br/>
	...
	<div class="container">
		<div class="fluid-container">
		 <table class="table">
			 ...
			 <tr>
				<td><h6><a href="numberOfMessages.php">Number of Messages Report</a></h6></td>
			</tr>
			 
			 <tr>
				<td><h6><a href="avgTutorMessages.php">Average Tutor Messages Report</a></h6></td>
			</tr>
			 <tr>
				<td><h6><a href="noTutorReport.php">Student Allocation Report</a></h6></td>
			</tr>
			<tr>
				<td><h6><a href="studentInteractionReport.php">Student Interaction Report</a></h6></td>
			</tr>
			</tbody>
		</table>
		</div>
