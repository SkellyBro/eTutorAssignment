	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="#"> Message Menu</a>
	    </div>
		<br/>
	...
	<div class="container">
		<div class="fluid-container">
		 <table class="table">
			 ...
			 <tr>
				<td><h6><a href="studentCreateMessage.php">Create Message</a></h6></td>
			</tr>
			<tr>
				<td><h6><a href="viewStudentMessageList.php">Message List</a></h6></td>
			</tr>
			<tr>
				<td><h6><a href="viewStudentMessagesReceived.php">View Received Messages</a></h6></td>
			</tr>
			<tr>
				<td><h6><a href="viewStudentRepliesSent.php">View Replies</a></h6></td>
			</tr>
			</tbody>
		</table>
		</div>
