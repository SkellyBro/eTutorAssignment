...
<html lang="en">
  ...
  <body>
	...
	if($stmt) {
		...
		//bind the results
		mysqli_stmt_bind_result($stmt, $docID, $dTitle, $dDesc, $dName, $uploadDate, $uploadedBy);
	
		//fetch the values 
		while(mysqli_stmt_fetch($stmt)) {
			echo ("<br />");		
			echo("<h5>Confirming Delete for: '".$dTitle."' that was uploaded on ".$uploadDate."  ?</h5>");
			echo("<font color='red'>Selecting 'Yes' will permanently delete this blog post! Do you want to continue? </font> <br/><br/>");
			echo("<a href='confirmUploadDelete.php?docID=".$docID."' class='btn btn-primary form-control'>Yes</a> <br/><br />");
			echo("<a href='viewPersonalUploads.php' class='btn btn-secondary form-control'>No</a><br/><br />");
