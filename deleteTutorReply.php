...
<html lang="en">
  ...
  <body>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="#.php"> Delete Reply</a>
	    </div>
		<br/>
		...
		<tr>
			<?php
				...
				if($stmt)
				{
					...
					//bind the results
					mysqli_stmt_bind_result($stmt, $rID, $s, $r, $rTitle, $cD, $mID, $date);
	...
	echo("<a href= 'confirmTutorDeleteReply.php?replyID=".$rID."' class='btn btn-primary form-control'>Confirm Delete</a>");
	echo("<br/> <br/>");
	echo("<a href= 'viewTutorRepliesSent.php?replyID=".$rID."' class='btn btn-secondary form-control'>Go Back To List Of Replies</a>");
	?> 
	</div>
	<br/>
