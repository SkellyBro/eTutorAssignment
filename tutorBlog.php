	...
	if($count == 0) {
		...
		include("DBConnect.php");
			...
			if(mysqli_stmt_execute($stmt)){
				...
				$error.= "<br/>Blog post has not been made successfully. Please contact a technician.";
				$count++;
			}	
...
<html lang="en">
  ...
  <body>
	...
	?>
		...
		<br />
		<!--Tutor Blog post Form-->
		<form class="horizontal" method="post" action="tutorBlog.php">
		
		<div class="form-group">
			<label class="control-label">Create your new Blog post below:</label> </br>

			<input class="form-control" type="text" name="title" value="" placeholder="Blog Title"/> 
	...
	<!--Viewing of all blogs made by the Tutor -->
	<?php
		//include the database connection
		include("DBConnect.php");
//query
			...
			<div class='col-sm-11'>
			  <div class='card'>
				...
				<div class='card-footer'>
					<a href='editTutorBlog.php?blogID=".$bId."' class='btn btn-primary'>Edit Blog post</a>
					<a href='blogComment.php?blogID=".$bId."'class='btn btn-primary'>Comment</a>
					<a href='deleteTutorBlog.php?blogID=".$bId."' class='btn btn-primary'>Delete Blog post?</a><br/>
