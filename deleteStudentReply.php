...
<html lang="en">
  ...
  <body>
	...
	echo("<a href= 'confirmStudentDeleteReply.php?replyID=".$rID."' class='btn btn-primary form-control'>Confirm Delete</a>");
	echo("<br/> <br/>");
	echo("<a href= 'viewStudentRepliesSent.php?replyID=".$rID."' class='btn btn-secondary form-control'>Go Back To List Of Replies</a>");
	?> 
	</div>
	<br/>
