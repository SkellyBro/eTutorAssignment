...
<html lang="en">
  ...
  <body>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="viewTutorMessagesReceived.php"> Received Messages &raquo; </a>
			<a class="BreadEff" href="#.php"> Message Reply</a>
	    </div>
		<br/>
	...
	$stmt = mysqli_prepare ($mysqli, "SELECT message.messageID, message.sender, useraccount.firstName, useraccount.lastName, message.recipient, message.messageTitle, message.contentDetails, message.messageDate FROM message, useraccount WHERE message.messageID = ?
	AND useraccount.userID=message.sender");
	...
	<form class="horizontal" method="post" action="createTutorReply.php?messageID=<?php echo($messageID); ?>">
		...
		<label>Message Title:</label>
			<input class="form-control" type="text" name="mTitle" readonly value="<?php echo($value4);?>"/>
			</br>
	...
	?>
		...
		<div class="form-group">
		<label>Message Title:</label>
			<input class="form-control" type="text" name="rTitle" value="" size="50"/>
			<br />
