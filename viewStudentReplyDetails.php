...
//get the value of the reply id from the url
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="#.php"> Reply Details</a>
	    </div>
		<br/>
	...
	<table class='table table-bordered table-striped table-hover'>
		...
		<tr>
			<?php
				...
				$stmt = mysqli_prepare($mysqli, "SELECT reply.replyID, reply.messageID, reply.recipient, reply.messageTitle, reply.contentDetails, reply.messageDate FROM reply WHERE reply.replyID = ?");
				if($stmt)
				{
					...
					//bind the results
					mysqli_stmt_bind_result($stmt, $rID, $mID, $r, $rTitle, $cD, $date);
					...
					while(mysqli_stmt_fetch($stmt))
					{
						echo "<tr> 
							...
							<td>".$cD."</td>
							<td>".$date."</td>
							<td><a href= 'editStudentReply.php?replyID=".$rID."'>Edit Reply</a></td>
							<td><a href= 'deleteStudentReply.php?replyID=".$rID."'>Delete Reply</a></td>
							</tr>";
					}
				}
			?>
