...
<html lang="en">
  ...
  <body>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="viewMessageList.php"> Message List</a>
	    </div>
		<br/>
	...
	<div class="container">
	<h1> Messaging </h1>
	<h5>List of Messages Sent</h5>
	<p>These are all of your sent messages. </p>
	...
	<table class='table table-bordered table-striped table-hover'>
		<tr> 
			...
			<th>View Message View Replies</th>
		</tr>
		...
		<tr>
			<?php
				...
				$stmt = mysqli_prepare($mysqli, "SELECT messageID, messageTitle FROM message WHERE message.sender = ?");
				if($stmt)
				{
					...
					//bind the results
					mysqli_stmt_bind_result($stmt, $mID, $mTitle);
					...
					while(mysqli_stmt_fetch($stmt))
					{
						echo "<tr> 
							<td>".$mID."</td>
							<td>".$mTitle."</td>
							<td><a href= 'viewTutorMessageDetails.php?messageID=".$mID."'>View Message Contents</a></td>
							<td><a href= 'viewTutorReplies.php?messageID=".$mID."'>View Replies</a></td>
							</tr>";
					}
				}
			?>
