  ...
  <body>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="#"> Delete Blog</a>
	    </div>
		<br/>
	...
	if($stmt) {
		...
		while(mysqli_stmt_fetch($stmt)) {
			...
			echo("<a href='confirmTutorBlogDelete.php?blogID=".$bId."' class='btn btn-primary form-control'>Yes</a> <br/><br />");
			echo("<a href='tutorBlog.php' class='btn btn-secondary form-control'>No</a><br/><br />");
