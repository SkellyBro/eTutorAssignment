...
<html lang="en">
  ...
  <body>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="#">User Dashboard</a>
	    </div>
		<br/>
	...
	if(isset($_SESSION)){
		$uID=$_SESSION['viewID'];
		$fn=$_SESSION['uFirstName'];
		$ln=$_SESSION['uLastName'];
		$pos=$_SESSION['uPosition'];
	}
	echo("<h1>Administrator Dashboard</h1>
		<h2>Currently Viewing: $fn $ln's Dashboard</h2>");
		...
		if($stmt){
			...
			//execute query 
				...
				while(mysqli_stmt_fetch($stmt)){
					...
					echo("<h4>No Message Replies have been sent by your tutor as yet.</h4>");
				}//end of resultSet if	
		}//end of stmt if
		...
		if($stmt){
			...
			//execute query 
				...
				while(mysqli_stmt_fetch($stmt))
					...
					echo("<h6>No Documents have been uploaded by your tutor as yet.</h6>");
				}//end of resultSet if
		}//end of stmt
		}else{
			echo"
				<h4> List of $fn's Students:</h4>
	
	
	
		<br />
		<!--Student Sorting/ Filtering Form-->
		<form class='horizontal' method='post' action='viewPersonDashboard.php'>
