...
<html lang="en">
  ...
  <body>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="#">Delete Message</a>
	    </div>
		<br/>
	...
	<p><font color='red'>Selecting 'Yes' will permanently delete this message! Do you want to continue? </font></p>		
		...
		<tr>
			<?php
				...
				if($stmt)
				{
					...
					//bind the results
					mysqli_stmt_bind_result($stmt, $mID, $r, $s, $mTitle, $cD, $date);
	...
	echo("<a href= 'confirmTutorDeleteMessage.php?messageID=".$mID."' class='btn btn-primary form-control'>Confirm Delete</a>");
	echo("<br/> <br/>");
	echo("<a href= 'viewTutorMessageList.php?messageID=".$mID."' class='btn btn-secondary form-control'>Go Back To List Of Messages</a>");
	?> 
