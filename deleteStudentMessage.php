...
<html lang="en">
  ...
  <body>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="deleteStudentMessage.php">Delete Message</a>
	    </div>
		<br/>
	...
	echo("<a href= 'confirmStudentDeleteMessage.php?messageID=".$mID."' class='btn btn-primary form-control'>Confirm Delete</a>");
	echo("<br/> <br/>");
	echo("<a href= 'viewStudentMessageList.php?messageID=".$mID."' class='btn btn-secondary form-control'>Go Back To List Of Messages</a>");
	?> 
	</div>
	<br/>
