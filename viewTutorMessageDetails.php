...
<html lang="en">
  ...
  <body>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="#"> Message Details</a>
	    </div>
		<br/>
	...
	<p>These are the full details of your selected message.</p>
	...
	<table class='table table-bordered table-striped table-hover'>
		...
		<tr>
			<?php
				...
				$stmt = mysqli_prepare($mysqli, "SELECT message.messageID, useraccount.firstName, useraccount.lastName, message.messageTitle, message.contentDetails, message.messageDate 
				...
				if($stmt)
				{
					...
					//bind the results
					mysqli_stmt_bind_result($stmt, $mID, $rFirstName, $rLastName, $mTitle, $cD, $date);
					...
					while(mysqli_stmt_fetch($stmt))
					{
						echo "<tr> 
							...
							<td>".$cD."</td>
							<td>".$date."</td>
							<td><a href= 'editTutorMessage.php?messageID=".$mID."'>Edit Message</a></td>
							<td><a href= 'deleteTutorMessage.php?messageID=".$mID."'>Delete Message</a></td>
							</tr>";
					}
				}
			?>
	...
	<br/>
	<form class="form-horizontal" method="post" action="viewTutorMessageDetails.php">
	<input type="submit" class="btn btn-sm btn-primary form-control" name="return" value="Return to Messages"/>
	</form>
