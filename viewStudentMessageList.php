	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="#.php"> Message List</a>
	    </div>
		<br/>
				...
				if($stmt)
				{
					...
					while(mysqli_stmt_fetch($stmt))
					{
						echo "<tr> 
							<td>".$mID."</td>
							<td>".$mTitle."</td>
							<td><a href= 'viewStudentMessageDetails.php?messageID=".$mID."'>View Message Contents</a></td>
							<td><a href= 'viewStudentReplies.php?messageID=".$mID."'>View Replies</a></td>
							</tr>";
					}
				}
			?>
