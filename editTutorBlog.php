...
<html lang="en">
  ...
  <body>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      <div class="row">
		 ...
		 <div>
			...
			<a class="BreadEff" href="blogTutor.php"> Blogs &raquo;</a>
			<a class="BreadEff" href="#"> Edit Blog</a>
	    </div>
	    </div>
		<br/>
	...
	?>
		...
		<form class="horizontal" method="post" action="editTutorBlog.php?blogID=<?php echo($blogID); ?>">
		...
		<textarea class="form-control" name="content"  rows="3" placeholder="Enter your text here.."><?php echo($value2);?></textarea>	
			</br>
			<input type="submit" class="btn btn-sm btn-primary form-control" name="submitEdit"/>
		 </div>
