	...
	<div class="container">
		<div class="fluid-container">
		 <table class="table">
			 ...
			 <tr>
				<td><h6><a href="tutorCreateMessage.php">Create Message</a></h6></td>
			</tr>
			<tr>
				<td><h6><a href="viewTutorMessageList.php">Message List</a></h6></td>
			</tr>
			<tr>
				<td><h6><a href="viewTutorMessagesReceived.php">View Received Messages</a></h6></td>
			</tr>
			<tr>
				<td><h6><a href="viewTutorRepliesSent.php">View Sent Replies</a></h6></td>
			</tr>
			</tbody>
		</table>
		</div>
