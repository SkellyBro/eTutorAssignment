  ...
  <body>
	...
	<h4>Confirm Delete Reply</h4>
			...
			<?php
				...
				$stmt = mysqli_prepare($mysqli, "DELETE FROM reply WHERE reply.replyID = ?");
	...
	<br/>
	   ...
	   <p> The reply has been deleted. You will be redirected to the replies list shortly </p>
	   
	   <meta http-equiv="refresh" content="5;URL='viewTutorRepliesSent.php'"/>
